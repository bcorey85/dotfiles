...
- **Theme:** two-axis family × light/dark switcher (default doom-one), synced across nvim/tmux/ghostty by the `theme-mode` script; families and per-family overrides live in `lua/config/theme-sync.lua`
