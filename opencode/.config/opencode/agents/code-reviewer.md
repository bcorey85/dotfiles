...
- **Missing documentation/comments** unless the project explicitly requires them (check AGENTS.md).
...
If the project has a AGENTS.md or similar conventions doc, read it. Stated conventions are the bar — your personal preferences are not.
