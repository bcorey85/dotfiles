...
<!-- Load-bearing headings: security-reviewer, perf-reviewer, and smell-reviewer inherit "Calibration Anchor", "Verify the Premise Before Flagging", the Step 3 severity definitions, and "Self-Check Before Reporting" BY NAME. Renaming any of them requires updating all three specialist agents (and the claude originals). -->
