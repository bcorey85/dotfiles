---
name: spec-leak-check
description: "Rewrite-and-diff audit of a research-questions file for leaked intent. Dispatched by goal-blind-researcher with the questions file only."
model: sonnet
tools: Read
maxTurns: 10
color: purple
