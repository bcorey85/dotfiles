...
2. Read each changed file + enough context to trace crossability — the reachable-bad-state machinery must actually exist. A violation of a _stated_ invariant (project AGENTS.md) is your strongest finding.
