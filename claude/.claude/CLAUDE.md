...
- Falsification → `/falsify`, and **only when I invoke it**, on one claim I name. Never a gate, never automatic, never a phase in another skill. It finds counterexamples that are _written down in the repo_; UNREFUTED means "not on disk," not "true" (4/13 blind).
