...
4. **Pull Jira ticket AC** — If a Jira ticket number was extracted in step 1, fetch the ticket using `getJiraIssue` (use the Jira Cloud ID from `docs/mcp-references/JIRA.md`) and extract the acceptance criteria from the description.
