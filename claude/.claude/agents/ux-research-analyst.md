...
1. **Context**: read `CLAUDE.md` for the stack, then the frontend structure — components, pages, layouts, routing. Recommendations must be feasible within the actual stack.
