...
| `starship`            | `~/.config/starship.toml`                                     | kanagawa dragon prompt                                                                                                                                                                                                                                                      |
...
- **Theme**: **terafox** (EdenEast/nightfox.nvim) — terafox (dark) / dayfox (light). Dark base `#152528`, fg `#e6eaea`, blue `#5a93aa` primary accent, cyan `#a1cdd8`, green `#7aa4a1`, red `#e85c51`. Light base `#f6f2ee`, fg `#3d2b5a`, blue `#2848a9` primary accent. tmux/nvim/Emacs share a light/dark toggle via `~/.cache/theme-mode` (see `scripts/.local/bin/theme-mode`); Emacs has no maintained nightfox port so it recolors bg/fg on modus-vivendi/modus-operandi instead. **Dark-only (no light toggle yet)**: starship, waybar, rofi, dunst, hyprland, hyprlock — all reskinned to **Kanagawa Dragon** (rebeccakoconnell/kanagawa.nvim dragon variant). Dragon base `#181616`, alt bg `#0d0c0c`, fg `#c5c9c5`, blue `#8ba4b0` primary accent, green `#87a987`, red `#c4746e`, orange `#b6927b`, violet `#8992a7`, border `#54546d`. GTK/Qt apps use Adwaita-dark.
