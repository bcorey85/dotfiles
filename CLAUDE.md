...
| `kitty`               | `~/.config/kitty/`                                            | nightfox (EdenEast/nightfox.nvim)                                                                                                                                                                                                                                           |
| `starship`            | `~/.config/starship.toml`                                     | nightfox prompt                                                                                                                                                                                                                                                             |
...
- **Theme**: **nightfox** (EdenEast/nightfox.nvim) — nightfox (dark) / dayfox (light). Dark base `#192330`, fg `#cdcecf`, blue `#719cd6` primary accent, cyan `#63cdcf`, green `#81b29a`, red `#c94f6d`. Light base `#f6f2ee`, fg `#3d2b5a`, blue `#2848a9` primary accent. tmux/nvim/Emacs share a light/dark toggle via `~/.cache/theme-mode` (see `scripts/.local/bin/theme-mode`); Emacs has no maintained nightfox port so it recolors bg/fg on modus-vivendi/modus-operandi instead. **Dark-only (no light toggle yet)**: kitty, starship, waybar, rofi, dunst, hyprland, hyprlock — all reskinned to nightfox's dark palette. GTK/Qt apps use Adwaita-dark.
