...
- **Theme:** onedark "darker" (navarasu/onedark.nvim), light/dark synced across nvim/tmux/ghostty by the `theme-mode` script; the family registry and its overrides live in `lua/config/theme-sync.lua`
