...
Authoritative spec for the QRSPI research step (run via `/eng-spec`). `IQ-XXX` in file names below is a placeholder: use the ticket prefix the task directory actually uses.
