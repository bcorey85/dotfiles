...
<!-- Load-bearing headings: security-reviewer and perf-reviewer inherit "Calibration Anchor", "Verify the Premise Before Flagging", "Persistent Memory", the Step 3 severity definitions, and "Self-Check Before Reporting" BY NAME. Renaming any of them requires updating both specialist agents (and their opencode ports). -->
